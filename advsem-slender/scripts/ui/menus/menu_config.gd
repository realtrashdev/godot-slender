...
enum MenuType { INTRO, MAIN, CUSTOMIZE, SETTINGS, EXTRAS, CREDITS, QUIT, MODE_SELECT, CHARACTER_SELECT, MAP_SELECT, START_GAME }
...
const MENU_SCENES = {
	...
	MenuType.EXTRAS: "res://scenes/ui/menus/menu_extras.tscn",
	MenuType.CREDITS: "res://scenes/ui/menus/menu_credits.tscn",
